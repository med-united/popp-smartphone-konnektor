...
/** Decoder for CETP protocol Reads: 4 bytes header + 4 bytes integer (length) + N bytes payload */
public class CetpProtocolDecoder extends ByteToMessageDecoder {
  ...
  protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
    ...
    var message =
        jaxbContext.createUnmarshaller().unmarshal(new java.io.ByteArrayInputStream(payload));
